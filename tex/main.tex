...
% Include image:
% TODO: AMD acquisition of Xilinx --- Intel acquisition of Altera
%% Modern processor structure
%% Seems increasingly likely that an FPGA fabric may be placed within
%% microprocessors
%% Incremental 'hardware' updates to custom processing pipelines --- fix
%% hardware vulnerabilities

% Coupled with:
% Growth of open-source FPGA tools \& alternative synthesis languages
% Easier to implement custom processing pipelines that are optimised for very
% specific operations
...
% Embedded device, variable footprint (Bluespec parameterised)
% Linear algebra accelerator --- machine learning, and
% Tightly coupled accelerator and CPU.

% Maximise throughput without sacrificing interopability
% --- Open source principles

% Shy away from SIMD extensions. No ARM license, 
